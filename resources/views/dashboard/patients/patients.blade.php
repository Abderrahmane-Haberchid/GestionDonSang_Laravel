...
<x-app-layout>
    <x-slot name="header">
        ...
        {{ __('Bienvenue à votre espace, ') }} {{ Auth::user()->lname }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <center>
                    <br />   
                    <p class="text text-primary"><b>Garder l'oeil sur la disponibilité de votre groupe sanguine et prenez un rdv pour une transfusion !</b></p>
                    <br />
                        </center>   
                        <br />
                        <table class="table">
